...
concrete case and work my way to the abstract definition.
...
objects, or, renaming (notice this pattern) to a DDD terminology value
objects and entities [cite:@evans_ddd_ref].

#+caption: CQRS/Traditional computer science term mapping
| CQRS         | Traditional         | Interpretation                                                                                       |
|--------------+---------------------+------------------------------------------------------------------------------------------------------|
| Entity       | Variable            | A symbol that represents a value of a given type. Can represent  different values on different calls |
| Value Object | Value               | An element of a set                                                                                  |
| Command      | assignment operator | Change the value of a variable                                                                       |
| Query        | function call       | Derive values from values                                                                            |
