...
problems should be: *You probably don't need anything beyond PostgreSQL,
and you're paying a real cost--- financial, operational, and
cognitive--- time you add one more moving part.*
...
Below are 2 screenshots from increase's sandbox dashboard that list
requirements and a conceptual model. Here are some interesting details:

1. Current and available balance are shown, both their present and historical values
2. Pending and settled transactions are shown, with information about their transfers
3. Accounts are defined by routing numbers and account numbers and have variable status
4. Transfers have a state machine like state where the progression
   between states needs to be exposed to the user. Some of these states
   are linked to pending/settled transactions.
...
*** Initial work, accounts and database level domain constraints
...
they are maintained over time.[fn:2]
...
as judged by the peer-review process. [fn:3]
#+end_quote
...
architectures[fn:6][cite:@kolny23:_scalin_prime_video;
...
To avoid that, here are 3 steps, and a reference:
   ...
   1) Ask and *embrace* feedback from bosses, peers and followers[fn:7],
...
least 2014[fn:8]. This has happened despite serious and well documented
[[#drawbacks][drawbacks]].
...
- It freezes APIs. Once a microservice establishes an API, it becomes
  ...
  API. Legacy APIs linger around, and new APIs are patched on top.[fn:9]
...
context-sensitive examples[fn:10]:
...
Conceptual schema -> Logical schema -> Physical schema [fn:10]
...
14 Themes of the Elite Private School Curriculum[fn:11]:
...
the IT sector in particular, is nominalism.[fn:12]
...
[fn:2] DO NOT manage your partitions by hand: Use pg_partman.

[fn:3] Have you noticed that the second paragraph supports what the ancients did, in refeering to Plato and Aristotle?

[fn:4] From the portuguese, translated by this author.

[fn:5] Recently I had a conversation on linkedin: https://www.linkedin.com/feed/update/urn:li:ugcPost:7316402764975075328?commentUrn=urn%3Ali%3Acomment%3A%28ugcPost%3A7316402764975075328%2C7316457084038930432%29&dashCommentUrn=urn%3Ali%3Afsd_comment%3A%287316457084038930432%2Curn%3Ali%3AugcPost%3A7316402764975075328%29

[fn:6] Including a claim of cost reductions of over 90%!

[fn:7] I like the terms superordinate, coordinates and subordinates, but
they are not in common usage

[fn:8] https://trends.google.com/trends/explore?date=all&geo=US&q=microservices

[fn:9] In a certain sense, all externally facing APIs face this. Microservices just make this problem worse by making everything ~external~ and not part of the same checkable runtime.

[fn:10] (schemas are synonymous to models in this context)

[fn:11] As listed in [[https://www.youtube.com/watch?v=IZBdv2yznmI][The Ultimate History Lesson]]

[fn:12] You will probably see me return to this topic in other posts.

[fn:13] I got the idea of such table from a similar table found on
chapter 25 of  [cite:@10.5555/861613]

[fn:14] The definitions come from [cite:@fallacies_iep], but the examples
