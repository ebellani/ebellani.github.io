...
John Taylor Gatto’s 14 Themes of the Elite Private School Curriculum[fn:1]
...
:PROPERTIES:
:EXPORT_FILE_NAME: what-is-wrong-w-dynamic
:EXPORT_DATE: 2023-11-20
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :slug what-is-wrong-w-dynamic
:END:


#+begin_quote
... rather than affording the freedom to ignore types, they instead
impose the bondage of restricting attention to a single type.
#+end_quote
[[https://existentialtype.wordpress.com/2011/03/19/dynamic-languages-are-static-languages/][from the great professor Harper]]
...
|-------------------------------------------------------------------------------+-------------------+----------+---------+-------+----------------|
| I was relatively inexperienced as a programmer when I started at Datarisk.    |                   |          |         |       |                |
| F# was at least as easy as any other language I knew to become productive at. |                   |          |         |       |                |
| F# made changing code easier and safer                                        |                   |          |         |       |                |
| F# helped us ship fewer bugs                                                  |                   |          |         |       |                |
| We spent less than 10% of our time re-working things due to bugs              |                   |          |         |       |                |
| Less than 5% of our changes in the code produced bugs                         |                   |          |         |       |                |
...
[fn:1] As listed in [[https://www.youtube.com/watch?v=IZBdv2yznmI][The Ultimate History Lesson]]

[fn:2] The manager can be seen as a vicarious owner of company
resources.
