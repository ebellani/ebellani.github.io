...
of that? Let's start by defining PC: it is a model of message-based
concurrent computation.

*** Definitions

Its essential features are[cite:@Pierce1995]:
...
specific [[#drawbacks][drawbacks]] that might now exist in other ways to implement the
PC.
...
context-sensitive examples[fn:2]:
...
[fn:6] The definitions come from [cite:@fallacies_iep], but the examples
