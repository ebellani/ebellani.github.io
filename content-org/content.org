    ...
    select exists (
      select 1
       ...
       where t.transfer_created_at         = p_transfer_created_at
         ...
         and t.routing_number              = p_routing_number
  ...
  begin
    if not finance.is_pending_transfer(
      ...
      raise exception
        ...
        NEW.transfer_created_at, NEW.account_number, NEW.routing_number,
        NEW.counterparty_account_number, NEW.counterparty_routing_number;
    end if;
    return NEW;
  end;
  $$;
...
like a mid/large bank like Nubank, 50 million[cite:@nubank2022pix]
~38GB, and for a global payment processor like VISA ~700Gb
[cite:@visa2025annual].
...
size, doubling the amounts above.
