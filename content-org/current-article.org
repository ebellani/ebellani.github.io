...
them as declarative as possible[fn:8].
...
[fn:5] Temporal tables can be used for several interesting features:
#+begin_quote
...
[fn:6] You can see a full tutorial on this library on  [cite:@clarkdave2015_temporal_tables]

[fn:7] (which is the case for PostgreSQL[cite:@postgresql2026unsupported] but not for Oracle[cite:@oracle2026assertion])

[fn:8] Such constraints are almost never created at the data level, exposing applications to the risk of failing audits and worse.

[fn:9] The definitions come from [cite:@fallacies_iep], but the examples
are adapted to this contex

[fn:10] I got the idea of such table from a similar table found on
...
[fn:15] https://trends.google.com/trends/explore?date=all&geo=US&q=microservices

[fn:16] I like the terms superordinate, coordinates and subordinates, but
they are not in common usage

[fn:17] Including a claim of cost reductions of over 90%!
1.

[fn:18] Recently I had a conversation on linkedin: https://www.linkedin.com/feed/update/urn:li:ugcPost:7316402764975075328?commentUrn=urn%3Ali%3Acomment%3A%28ugcPost%3A7316402764975075328%2C7316457084038930432%29&dashCommentUrn=urn%3Ali%3Afsd_comment%3A%287316457084038930432%2Curn%3Ali%3AugcPost%3A7316402764975075328%29

[fn:19] From the portuguese, translated by this author.

[fn:20] Have you noticed that the second paragraph supports what the ancients did, in refeering to Plato and Aristotle?

[fn:21] DO NOT manage your partitions by hand: Use pg_partman.
